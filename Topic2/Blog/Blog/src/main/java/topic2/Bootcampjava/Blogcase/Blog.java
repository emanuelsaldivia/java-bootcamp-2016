...
public class Blog {
	...
	public boolean deletePost (int id){ //we are suposing that the entry id is the same than the position it is submited in the list. Also we always know the id of the post to be deleted.
